...
public final class PassengersPerAirlineAnalysis {

  public static void main(String[] args) throws Exception {

    SparkSession spark = SparkSession
      .builder()
      .appName("PassengersPerAirlineAnalysis")
      .getOrCreate();
    ...
    JavaPairRDD<String, Double> airlinePassengersPerMonth = rows.mapToPair(row -> {
        try {
            ...
            String passengers = row.getString(0);
            return new Tuple2<>(year + "-" + month + ",\"" + uniqueCarrierName + "\"", Double.parseDouble(passengers));
        }
