...
public final class MailPerAirlineAnalysis {

  public static void main(String[] args) throws Exception {

    SparkSession spark = SparkSession
      .builder()
      .appName("MailPerAirlineAnalysis")
      .getOrCreate();
    ...
    JavaPairRDD<String, Double> airlineMailPerMonth = rows.mapToPair(row -> {
        try {
            ...
            String mail = row.getString(2);
            return new Tuple2<>(year + "-" + month + ",\"" + uniqueCarrierName + "\"", Double.parseDouble(mail));
        }
    ...
    List<Tuple2<String, Double>> output = airlineMailPerMonth.collect();
    File outputFile = new File("./airline-mail-output.csv");
